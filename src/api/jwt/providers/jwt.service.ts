...
import { IEmailPayload, IEmailToken } from 'src/common/interfaces/email/email-token';
import { IJwt } from 'src/common/interfaces/jwt.interface';
import { IAccessPayload, IAccessToken } from 'src/common/interfaces/token/access-token.interface';
import { IRefreshPayload, IRefreshToken } from 'src/common/interfaces/token/refresh-token.interface';
